...
<div class="container eventdiajukan-content mt-4">
    <h4>Event yang Diajukan</h4>
    <hr>
    <small>*Dibawah ini merupakan daftar event yang sedang Anda ajukan kepada sistem STEVEN.</small>
    <div class="row mt-5">
